...
/**
 * Markdown content for the Code Analyzer skill.
 * Separated from skill-generator.ts to avoid template literal escaping issues.
 */

export function codeAnalyzerSkillMd(): string {
  const lines = [
    '---',
