...
export const devopsProfile: Profile = {
  ...
  ruleContent(): string {
    return [
      ...
      '- **No Ninja Edits.** Always summarize proposed pipeline/deployment changes and get explicit agreement before modifying any file.',
      '- Provide pros/cons for infrastructure and release strategy decisions.',
      '',
